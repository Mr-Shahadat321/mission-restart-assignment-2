...
const ProgressCard = ({ progress }) => {
  return (
    <div className="w-11/12 mx-auto my-12 grid md:grid-cols-2 gap-4">
      <div className="h-40 linearGradient1 flex items-center justify-center flex-col rounded-xl">
        ...
        <h1 className="text-5xl font-bold text-white">{progress.inProgress}</h1>
      </div>
      ...
      <div className="h-40 linearGradient2 flex items-center justify-center flex-col rounded-xl">
        ...
        <h1 className="text-5xl font-bold text-white">{progress.resolved}</h1>
      </div>
    </div>
  );
};
